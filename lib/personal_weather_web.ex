defmodule PersonalWeatherWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PersonalWeatherWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/personal_weather_web/templates",
        namespace: PersonalWeatherWeb
      ...
      import PersonalWeatherWeb.ErrorHelpers
      import PersonalWeatherWeb.Gettext
      alias PersonalWeatherWeb.Router.Helpers, as: Routes
    end
  end
